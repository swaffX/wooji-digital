...
const categories = [
  { label: 'Genel', count: 5 },
  { label: 'Fiyatlandırma', count: 3 },
  { label: 'Teknik', count: 2 },
]
  ...
  return (
    <SiteLayout>
      <PageHeader
        ...
        title="Sıkça Sorulan"
        highlight="Sorular"
        desc="Merak ettiğiniz her konuya cevap vermeye çalışıyoruz. Cevap bulamazsanız doğrudan ulaşın."
      />
      ...
      <section className={styles.categoriesSection}>
        <div className="wrap">
          <div className={styles.categories}>
            {categories.map((c) => (
              <div key={c.label} className={styles.catChip}>
                <span>{c.label}</span>
        ...
        <div className="wrap">
          <div className={`${styles.stillBox} reveal`}>
            ...
            <div className={styles.stillActions}>
              ...
              <a href="https://wa.me/905XXXXXXXXX" className="btn btn-line" target="_blank" rel="noopener noreferrer">
